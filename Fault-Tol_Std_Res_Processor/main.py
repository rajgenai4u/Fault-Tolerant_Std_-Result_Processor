...
def process_student_batch(student_records):
    ...
    for record in student_records:
        ...
        # Fault-tolerant exception handling catches error types independently
            ...
            # Catch unexpected runtime errors without terminating batch execution
...
if __name__ == "__main__":
    ...
    dataset = [
        ...
        {"student_id": "S105", "name": "Eva Green", "marks": [35, 80, 75, 90, 85]},            # Fail condition check (one mark < 40)
        {"student_id": "S106", "name": "Frank Castle", "marks": [70, 80, 90]},                 # Incorrect subject count (< 5)
    ]
